    classdef LocationModKS < AuditoryFrontEndDepKS
    ...
    methods
        function obj = LocationModKS(gmName, angularResolution, bTrain)
            param = genParStruct(...
                'fb_type', 'gammatone', ...
                'fb_lowFreqHz', 80, ...
                'fb_highFreqHz', 8000, ...
        ...
        function execute(obj)
            ...
            figure(2);
            a=sum(itds,1)/size(itds,1);
            b=sum(ilds,1)/size(ilds,1);
            scatter(a,b);
            axis([-1 1 -10 10]);
            ...
            figure(3);
            plot(locHyp.posteriors);
            if (max(locHyp.posteriors>0.3))
                obj.blackboard.addData('locationHypotheses', ...
                    locHyp, false, obj.trigger.tmIdx);
                notify(obj, 'KsFiredEvent', BlackboardEventData( obj.trigger.tmIdx ));
                fprintf('new location hypothesis generated: %f\n',obj.trigger.tmIdx);
            end
        end
